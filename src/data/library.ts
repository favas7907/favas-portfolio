...
export const LIBRARY_DATA: LibraryItem[] = [
  {
    ...
    heroImage: 'https://picsum.photos/seed/talk-react/1200/600',
    photos: [
      'https://picsum.photos/seed/talk-react-1/600/600',
      'https://picsum.photos/seed/talk-react-2/600/600'
    ],
    links: [
  ...
  },
  {
    ...
    heroImage: 'https://picsum.photos/seed/workshop-security/1200/600',
    links: [
  ...
  },
  {
    ...
    heroImage: 'https://picsum.photos/seed/article-hackathon/1200/600',
    links: [
  ...
  },
  {
    ...
    whatILearned: 'The underlying cryptography of DIDs is solid, but the user experience remains the biggest hurdle to adoption. Bridging the gap between a crypto wallet and a seamless login experience requires significant compromise.',
    ...
    heroImage: 'https://picsum.photos/seed/research-web3/1200/600',
    links: [
  ...
  },
  {
    ...
    heroImage: 'https://picsum.photos/seed/hackathon-web3/1200/600'
  },
  {
    ...
    context: 'A comprehensive certification verifying the ability to design cost and performance optimized, highly available, and scalable systems on AWS.',
    ...
    heroImage: 'https://picsum.photos/seed/cert-aws/1200/600'
  }
];
